      ...
      <header className="gestao-page-header">
        <div className="gestao-page-header-content">
          ...
          <div className="gestao-page-title-wrapper">
            <FolderOutlined className="gestao-page-title-icon" />
            <div>
              <h1 className="gestao-page-title">Gestão de Categorias</h1>
              <p className="gestao-page-subtitle">Gerencie categorias de documentos</p>
            </div>
          </div>
        </div>
      </header>
